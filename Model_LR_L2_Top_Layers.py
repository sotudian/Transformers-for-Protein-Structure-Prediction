...
if Training_Flag:
    MODEL = my_train(X, Y_Classification, model='LR', penalty='l2', cv=2, scoring='f1', class_weight= 'balanced',seed=0)    
    pickle.dump(MODEL, open('Class_LRL2_Top20.sav', 'wb'))                 
else:
    MODEL = pickle.load(open('Class_LRL2_Top20.sav', 'rb'))
